Page({
  ...
  calculateResult(score) {
    ...
    if (score >= 85) {
      level = '❤️ 85-100分：【爱心全满 —— 遇到了"人间神仙快充宝"】'
      levelShort = '爱心全满'
      batteryIcon = '❤️❤️❤️❤️❤️'
      batteryPercent = '爱意 100%'
      ...
      level = '💗 65-84分：【爱心3/5 —— 自动进入"日常省电模式"】'
      levelShort = '爱心3/5省电模式'
      batteryIcon = '❤️❤️❤️🤍🤍'
      batteryPercent = '爱意 60%'
      ...
      level = '💔 45-64分：【爱心1/5 —— 陷入"疯狂漏电与内耗期"】'
      levelShort = '爱心1/5漏电警告'
      batteryIcon = '❤️🤍🤍🤍🤍'
      batteryPercent = '爱意 20%'
      ...
      level = '🖤 20-44分：【爱心破碎 —— 关系进入"重度有毒（Toxic）状态"】'
      levelShort = '爱心破碎'
      batteryIcon = '🖤💔🤍🤍🤍'
      batteryPercent = '爱意 1%'
